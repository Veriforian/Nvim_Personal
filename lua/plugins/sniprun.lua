return {
  ...
  config = function()
    ...
    vim.api.nvim_set_keymap("n", "<leader>rs", "<Plug>SnipReset", { silent = true })
    vim.api.nvim_set_keymap("v", "<leader>rs", "<Plug>SnipReset", { silent = true })
    vim.api.nvim_set_keymap("n", "<leader>rc", "<Plug>SnipClose", { silent = true })
    vim.api.nvim_set_keymap("v", "<leader>rc", "<Plug>SnipClose", { silent = true })
    vim.api.nvim_set_keymap("n", "<leader>rl", "<Plug>SnipLive", { silent = true })
    vim.api.nvim_set_keymap("v", "<leader>rl", "<Plug>SnipLive", { silent = true })
    vim.api.nvim_set_keymap("n", "<leader>ri", "<Plug>SnipInfo", { silent = true })
